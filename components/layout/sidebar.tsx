                ...
                <div className="px-4 pb-2 flex flex-col gap-1.5">
                    ...
                    <div className="flex p-1 bg-sidebar-accent/50 rounded-lg">
                        <Link
                            href="/journal"
                            onClick={onClose}
                            className={cn("flex-1 flex items-center justify-center gap-2 py-1.5 text-xs rounded-md transition-all", pathname === "/journal" ? "text-white font-semibold" : "text-sidebar-foreground/60 hover:text-sidebar-foreground font-semibold")}
                        >
                        ...
                        <Link
                            href="/deep-work"
                            onClick={onClose}
                            className={cn("flex-1 flex items-center justify-center gap-2 py-1.5 text-xs rounded-md transition-all", pathname === "/deep-work" ? "text-white font-semibold" : "text-sidebar-foreground/60 hover:text-sidebar-foreground font-semibold")}
                        >
                            <Brain className="h-3.5 w-3.5" /> Deep Work
                        </Link>
                    </div>
                </div>
